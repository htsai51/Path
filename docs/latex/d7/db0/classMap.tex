...
\begin{DoxyCode}
219                          \{
220     \textcolor{keywordtype}{int} x = 0;
221     \textcolor{keywordtype}{int} y = 0;
222     \textcolor{keywordtype}{int} index = 0;
223 
224 
225     \textcolor{keywordtype}{int} displayRow = row * 2 + 1;
226     \textcolor{keywordtype}{int} displayCol = col * 2 + 1;
227 
228     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < displayRow; ++i) \{
229         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < displayCol; ++j) \{
230             \textcolor{keywordflow}{if} (i % 2 == 0) \{
231                 \textcolor{keywordflow}{if} (j % 2 == 0)
232                     cout << \textcolor{stringliteral}{" "};
233                 \textcolor{keywordflow}{else}
234                     cout << \textcolor{stringliteral}{"---"};
235             \} \textcolor{keywordflow}{else} \{
236                 \textcolor{keywordflow}{if} (j % 2 == 0) \{
...
242                     index = (x * col + y + 1);
243 
244                     \textcolor{keywordflow}{if} (mapArray[index-1] == numeric\_limits<int>::max())
245                         cout << \textcolor{stringliteral}{"   "};
246                     \textcolor{keywordflow}{else}
247                         cout << std::setw(3) << index;
248                 \}
249             \}
250         \}
251         cout << endl;
...
\begin{DoxyCode}
173                                        \{
174     \textcolor{keywordtype}{int} x = 0;
175     \textcolor{keywordtype}{int} y = 0;
176     \textcolor{keywordtype}{int} index = 0;
177 
178     \textcolor{keywordtype}{int} displayRow = row * 2 + 1;
179     \textcolor{keywordtype}{int} displayCol = col * 2 + 1;
180 
181     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < displayRow; ++i) \{
182         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < displayCol; ++j) \{
183             \textcolor{keywordflow}{if} (i % 2 == 0) \{
184                 \textcolor{keywordflow}{if} (j % 2 == 0)
185                     cout << \textcolor{stringliteral}{" "};
186                 \textcolor{keywordflow}{else}
187                     cout << \textcolor{stringliteral}{"---"};
188             \} \textcolor{keywordflow}{else} \{
189                 \textcolor{keywordflow}{if} (j % 2 == 0) \{
...
195                     index = (x * col + y + 1);
196 
197                     \textcolor{keywordflow}{if} ((index == startIdx) && (index == goalIdx))
198                         cout << \textcolor{stringliteral}{"S/G"};
199                     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (index == startIdx)
200                         cout << \textcolor{stringliteral}{" S "};
201                     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (index == goalIdx)
202                         cout << \textcolor{stringliteral}{" G "};
203                     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (isInPath(index, path))
204                         cout << \textcolor{stringliteral}{" * "};
205                     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (mapArray[index-1] == numeric\_limits<int>::max())
206                         cout << \textcolor{stringliteral}{" O "};
...
114 
115                 \textcolor{keywordflow}{if} ((index == startIdx) && (index == goalIdx))
116                     outputFs << \textcolor{stringliteral}{"S/G"};
117                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (index == startIdx)
118                     outputFs << \textcolor{stringliteral}{"S"};
119                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (index == goalIdx)
120                     outputFs << \textcolor{stringliteral}{"G"};
121                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (isInPath(index, path))
122                     outputFs << \textcolor{stringliteral}{"*"};
123                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (mapArray[index-1] == numeric\_limits<int>::max())
124                     outputFs << \textcolor{stringliteral}{"O"};
125                 \textcolor{keywordflow}{else}
126                     outputFs << \textcolor{stringliteral}{" "};
127 
128 
129                 \textcolor{keywordflow}{if} (j < col-1)
130                     outputFs << \textcolor{stringliteral}{","};
131             \}
132             outputFs << endl;
133         \}
134 
